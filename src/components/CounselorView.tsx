  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "1",
      role: "model",
      content: `سلام ${student.name} گرامی! من دکتر جبه‌دار، مشاور علمی و برنامه‌ریز ارشد مهندسی برق هستم. کارنامه شبیه‌ساز، نقاط قوت و ضعف و پیش‌نویس مطالعه شما را بررسی کردم. امروز چطور می‌توانم در رفع تله‌های مدار الکتریکی، روش تحلیل سیگنال و سیستم یا مهار اضطراب و خستگی دوران کنکور به شما کمک کنم؟`,
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-5 rounded-2xl border border-indigo-100 shadow-sm flex items-center justify-between">
                  <div className="space-y-1 text-right">
                    ...
                    <p className="text-[9px] text-slate-400">تحلیل تله‌های تستی مدار و ریاضیات</p>
                  </div>
                </div>
