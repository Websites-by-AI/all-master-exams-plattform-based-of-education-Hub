  ...
  if (!saved) return [
    {
      ...
      legalNote: "برای محاسبه ثابت زمانی (tau) در مدار مرتبه اول، حتماً باید مقاومت تِوِنی (Thevenin) دیده شده از دو سر عنصر ذخیره‌ساز انرژی (L یا C) را محاسبه کنید.",
      importance: "high",
    ...
    },
    {
      ...
      legalNote: "پایداری BIBO مستلزم آن است که تمام قطب‌ها در سمت چپ صفحه s باشند. وجود قطب‌های غیرتکراری روی محور jw باعث پایداری مرزی می‌شود که در ورودی پله، خروجی کراندار نیست.",
      importance: "medium",
      createdAt: "۱۴۰۵/۰۲/۲۸"
    }
  ];
