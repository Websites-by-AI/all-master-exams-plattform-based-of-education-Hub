export interface Student {
  id: string;
  name: string; // نام داوطلب آزمون‌های عالی ارشد و دکتری تخصصی سامانه میزان
...
export interface Exam {
  id: string;
  date: string; // تاریخ برگزاری آزمون آزمایشی سامانه میزان
...
export interface Weakness {
  ...
  recommendation: string; // توصیه مربیان سامانه میزان جهت اصلاح علمی و حذف تله تستی
...
export interface PsychologicalAnalysis {
  ...
  description: string; // تحلیل روانشناختی و برنامه‌ریزی مربیان سامانه میزان درباره ریتم مطالعاتی داوطلب
